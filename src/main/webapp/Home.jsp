...
.carousel-item:nth-child(1) {
	background-image:
		url('https://routine.vn/media/banner/tmp/images/nam_-_1920x984.jpg');
...
.carousel-item:nth-child(2) {
	background-image:
		url('https://routine.vn/media/banner/tmp/images/n_-_1920_x_984.jpg');
	background-repeat: no-repeat;
	background-size: 100% 100%;
	background-position: center center;
}
...
.carousel-item:nth-child(3) {
	background-image:
		url('https://routine.vn/media/banner/tmp/images/E-com_Resize_tang_B_nh_n_c_1920x984_-_update.jpg');
	background-repeat: no-repeat;
	background-size: 100% 100%;
	background-position: center center;
}
...
<body class="skin-light" onload="loadAmountCart()">
	...
	<div class="container">
		...
		<div class="row" style="margin-top: 25px">
			<h1 style="text-align: center; width: 100%" id="nike">ÁO POLO
				MỚI NHẤT</h1>
			<div class="col-sm-12">
		...
		<div class="row" style="margin-top: 25px">
			<h1 style="text-align: center; width: 100%" id="adidas">QUẦN
				JEAN MỚI NHẤT</h1>
			<div class="col-sm-12">
					...
					<div class=" col-12 col-md-12 col-lg-6">
						<div class="card-body">
							...
							<h2 class="card-title show_txt"
								style="text-align: center; font-size: 24pt;">Fashion Family</h2>
							<p style="text-align: center;">Fashion Family đang tạo ra
								những bộ trang phục sản xuất trong nước hoàn toàn có thể sánh
								ngang với các thương hiệu thời trang nam đến từ nước ngoài về
								kiểu dáng, chất lượng lẫn phong cách thời trang.</p>
							<p>Như ý nghĩa của tên gọi, trang phục của Fashion Family
								hướng đến việc trở thành thói quen, lựa chọn hàng ngày cho nam
								giới trong mọi tình huống. Bởi Fashion Family hiểu rằng, sự tự
								tin về phong cách ăn mặc sẽ làm nền tảng, tạo động lực cổ vũ mỗi
								người mạnh dạn theo đuổi những điều mình mong muốn. Trong đó,
								trang phục nam phải mang vẻ đẹp lịch lãm, hợp mốt và tạo sự
								thoải mái, quan trọng nhất là mang đến cảm giác “được là chính
								mình” cho người mặc. .</p>
						</div>
					</div>
					<div class=" col-12 col-md-12 col-lg-6">
						<img class="card-img-top"
